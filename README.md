...
Nel foglio "<b>Cassa_AAAA</b>", dove AAAA è l'anno di riferimento, vengono registrati i movimenti da rendicontare.
 ![Descrizione dell'immagine](https://github.com/FoliniC/RendicontoCassaETS/blob/main/RendicontoDiCassa_EsempioCassa.png?raw=true) <br/>
...
In alto a destra del foglio "Cassa_AAAA" c'è il tasto "<b>Calcola bilancio annuale</b>" che crea il foglio "Bilancio_AAAA" seguendo lo schema ministeriale totalizzando le voci.<br/> ![Descrizione dell'immagine](https://github.com/FoliniC/RendicontoCassaETS/blob/main/RendicontoDiCassa_EsempioBilancio.png?raw=true) <br/>Nel caso che gli importi di una stessa voce non abbiano lo stesso segno viene segnalato un errore e apparirà la totalizzazione con valore -1.<br/>
